	...
	# 温度グラフ作成.
	  Numo.gnuplot do
    	#    debug_on
    		...
    		set terminal: "png"
    		set output:   "#{pubdir_temp}/iot-19_iot-20_iot-23_iot-24_temp_#{time_from.strftime("%Y%m%d")}.png"
	...
	Numo.gnuplot do
 		...
 		set xlabel:   "time"
   		set xdata:    "time"
    		...
    		set xtics:    "rotate by -60"
    		set terminal: "png"
    		set output:   "#{pubdir_humi}/iot-19_iot-20_iot-23_iot-24_humi_#{time_from.strftime("%Y%m%d")}.png"
    		set :datafile, :missing, "#{miss}" # 欠損値
    		set :nokey # 凡例なし
    		set key: "box" #凡例あり
  	...
  	Numo.gnuplot do
		...
		set xtics:    "rotate by -60"
		set terminal: "png"
    		set output:   "#{pubdir_didx}/iot-19_iot-20_iot-23_iot-24_didx_#{time_from.strftime("%Y%m%d")}.png"
		set :datafile, :missing, "#{miss}" # 欠損値
		set :nokey # 凡例なし
		set key: "box" #凡例あり
