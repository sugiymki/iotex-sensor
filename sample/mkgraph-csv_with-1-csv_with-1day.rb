...
# 公開ディレクトリ
pubdir = "/home/j1403/public_html/graph-csv_with-1day" 

# データ置き場
srcdir = "/home/j1403/public_html/data_csv_1day"
...
[7, 30, 90, 120, 240, 360].each do |range|
  ...
  plot [time_list, temp_list["mean"], using:'1:($2)', with:"linespoints", lc_rgb:"green", lw:3, title:"mean"],
       [time_list, temp_list["median"],  using:'1:($2)', with:"linespoints", lc_rgb:"red",   lw:3, title:"median"]
  end
